        ...
        threads.map(thread =>
          ...
          key={thread.threadId}
            ...
            {props.currentThreadId === thread.threadId ?
              <td style={style} className="threads-from-address">
                {thread.messages[0].headers.From.split('<')[0] || thread.messages[0].headers['Return-Path']}
              </td> :
              <td className="threads-from-address">
                {thread.messages[0].headers.From.split('<')[0] || thread.messages[0].headers['Return-Path']}
              </td>
            }
          ...
          {props.currentThreadId === thread.threadId ?
            ...
            <td className="threads-sl-snippet">
              ...
              <span className="threads-snippet">{thread.snippet}</span>
            </td>
          }
        </tr>
        )
